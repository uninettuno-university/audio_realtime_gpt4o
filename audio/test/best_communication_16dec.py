...
async def send_audio_file(websocket):
    global awaiting_response_commiting, pause_ai_response
    ...
    try:
        ...
        while mic_active:
           ...
           if  (pause_ai_response and not awaiting_response_commiting) or not mic_queue.empty():
...
async def process_server_response(websocket):
    global awaiting_response_commiting, mic_active, pause_ai_response
    ...
    try:
        ...
        while mic_active:
            ...
            if event_type == 'input_audio_buffer.speech_started':
                ...
                logging.info("User is speaking. Sending response.cancel to stop AI.")
